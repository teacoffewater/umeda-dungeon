...
import { WHITY_BLOCKS, WHITY_REAL_POS } from './detail_whity.js'; // tools/gen_detail_whity.py が生成
...
const FLOOR_POLYS = [
  ...
  { floor: 'B1', zone: 'umechika', pts: [[1042.8, 960.8], [1029.9, 962.8], [1040.9, 985.8], [1041.0, 976.7], [1045.7, 975.3], [1043.2, 967.1], [1048.8, 965.9], [1048.6, 960.0]] },
...
function enterDetail(zoneId) {
  ...
  // 施設以外を隠す(他フロア・地上・他ゾーンの床と店・範囲外の昇降設備・線路・ラベル)
