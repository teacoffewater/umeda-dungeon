...
const ZONES = {
  ...
  dojima_flat: { name: '堂島ふらっと',          color: 0x3f9a6e, label: [661, 1507] },      // 近鉄堂島ビルB1F(ドーチカC83直結)。案内板の緑
...
const EDGES = [
  ...
  ['dotica_avz_m', 'dojima_flat', 6, 'dotica'], // C83: ドーチカ西側の階段(ESC)→近鉄堂島ビルB1F「堂島ふらっと」。位置は公式マップの C83(通路の同じ緯度の西側)
