...
const NODES = [
  ...
  J('nishi_y',     258, 1424),        // ガーデンアベニュー南西端のY字路(出口6-1/6-2への分岐)。現地写真 2026-08-23
...
const EDGES = [
  ...
  ['nishi_y', 'exit_6_1', 8, 'nishi_umeda'],
