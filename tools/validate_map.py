...
KNOWN_EXCLAVES = [('S1', '_neutral', 797, 727),      # ヨドバシ⇔ルクア間の高架下連絡路
                  ...
                  ('S1', 'osaka_sta', 835, 723),     # ガイドマップの通路: 三番街西口↔リンクスの連絡通路の駅側の片(浅層。_neutral の帯でつながる)
                  ('S1', 'osaka_sta', 680, 785),     # ガイドマップの通路: JR大阪駅北側(ルクア前)の片(浅層)
                  ('S1', '_neutral', 796, 750)]      # ガイドマップの通路: ヨドバシ⇔ルクア間の高架下連絡路(浅層)
