...
FACILITY_BLD = {
    ...
    'kiyo': bpoly(221966330),             # 紀陽ビル(B1F、ドーチカ南端直結)
...
MASK_HOLES = {'sanban': whity_band,
              ...
              'hanshin_dept': f40_band, 'avanza': dotica_band, 'dojima_flat': dotica_band, 'kanden': dotica_band, 'kiyo': dotica_band,  # ekimae×diamorの貫通穴は撤去(バラエティSTは第4ビル西縁沿い・貫通しない 2026-07-10)
...
BUILDING_PLATES = [
    ...
    ('B1', 'avanza', plate(178958655)),              # 堂島アバンザ(ドーチカ直結。3本の通路は dotica の帯)
    ...
    ('B1', 'kiyo', plate(221966330)),                # 紀陽ビル B1F(ドーチカ南端直結)
